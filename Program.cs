using BraveNotificationManager;
...
builder.Services.AddSingleton<AdaptiveCardBuilderFactory>();
builder.Services.AddSingleton<WebhookService>();
builder.Services.AddSingleton<HandleAlertResponse>();
builder.Services.AddSingleton<HandleSurveyResponse>();
    ...
    var options = new ConversationOptions()
    {
        ...
        CardAction = new CardActionOptions()
        {
            Actions = new List<IAdaptiveCardActionHandler> { 
                sp.GetService<HandleAlertResponse>(),
                sp.GetService<HandleSurveyResponse>()
            }
